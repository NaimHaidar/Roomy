...
!(function () {
  if (typeof PerfectScrollbar !== "undefined" && navigator.platform.indexOf("Win") > -1) {
  new PerfectScrollbar(".sidebar");
  new PerfectScrollbar(".sidebar-wrapper");
  new PerfectScrollbar(".main-panel");
  $("html").addClass("perfect-scrollbar-on");
  console.log("PerfectScrollbar is active");
} else {
  $("html").addClass("perfect-scrollbar-off");
  console.log("PerfectScrollbar is not defined");
}
})(),
  (backgroundOrange =
    navbar_initialized =
